...
module "aws_key_pair" {
  source = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/keypair"
...
module "aws_vpc" {
  source     = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/vpc"
...
module "aws_vpc_network" {
  source    = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/network/igw_nat_subnet"
...
module "aws_public_subnet_a" { 
  source     = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/subnet"
...
module "aws_sg_default" {
  source = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/security"
  vpc_id = module.aws_vpc.vpc_id
...
module "aws_sg_react_web" {
  source = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/security/react"
  vpc_id = module.aws_vpc.vpc_id
...
# open port 22 - 8080
module "aws_sg_was" {
  source = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/security/was"
  vpc_id = module.aws_vpc.vpc_id
...
module "aws_ec2_public_docker_springboot_ec2" {
 source        = "git::https://github.com/azjaehyun/terra-middle-class-module.git//terraform/modules/aws/ec2/docker_ec2"
...
module "aws_ec2_public_docker_react_ec2" {
  ...
  depends_on = [module.aws_ec2_public_docker_springboot_ec2]
}
